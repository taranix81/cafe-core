...
public class CafeBeansResolvableService {
    ...
    private CafeBeansResolvableService(CafeBeanDefinitionService classDescriptors) {
        this.classDescriptors = classDescriptors;

    }

    public static CafeBeansResolvableService from(final CafeBeanDefinitionService classDescriptors) {
    ...
    public BeanTypeKey notResolvableType(CafeMemberInfo cafeMemberInfo) {
        ...
        if (cafeMemberInfo.hasDependencies()) {
            Set<BeanTypeKey> providedTypeKeys = classDescriptors.getMemberDependencyResolverRegistry().providersTypeKeys(cafeMemberInfo);
