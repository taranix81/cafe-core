...
public class CheckButtonWidgetWrapper implements CafeWidgetWrapper<Boolean> {

    private final Button widget;

    public CheckButtonWidgetWrapper(Composite parent) {
        this.widget = new Button(parent, SWT.CHECK);
    }

    public CheckButtonWidgetWrapper(Button existing) {
    ...
    public void addChangeListener(Consumer<Boolean> listener) {
        widget.addSelectionListener(new org.eclipse.swt.events.SelectionAdapter() {
            @Override
