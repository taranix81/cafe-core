...
public class ToggleButtonWidgetWrapper implements CafeWidgetWrapper<Boolean> {

    private final Button widget;

    public ToggleButtonWidgetWrapper(Composite parent) {
        this.widget = new Button(parent, SWT.TOGGLE);
    }

    public ToggleButtonWidgetWrapper(Button existing) {
