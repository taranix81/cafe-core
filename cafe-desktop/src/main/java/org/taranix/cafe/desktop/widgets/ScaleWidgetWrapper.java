...
public class ScaleWidgetWrapper implements CafeWidgetWrapper<Integer> {

    private final Scale widget;

    public ScaleWidgetWrapper(Composite parent) {
        this.widget = new Scale(parent, SWT.HORIZONTAL);
    }

    public ScaleWidgetWrapper(Composite parent, int style) {
        this.widget = new Scale(parent, style);
    }

    public ScaleWidgetWrapper(Scale existing) {
